...
6. Ошибка в задании в последней ручке reassign: в openapi в примере old_reviewer_id вместо old_user_id, как в схеме. В коде ожидается old_user_id
...
7. /pullRequest/reassign ![alt text]![alt text](./assets/image-13.png)
